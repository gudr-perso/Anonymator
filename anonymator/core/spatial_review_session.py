# anonymator/core/spatial_review_session.py
...
class SpatialReviewSession:
    """État de revue d'une source spatiale — PDF multi-pages ou image, une page
    unique n'étant qu'un cas particulier (non-Qt). Miroir de FileReviewSession, indexé par
    ...
    def __init__(self, pages: list[PageScan], ref):
        ...
        for ps in pages:
            ...
            for e in ps.entities:
                rects = rects_for_entity(page_text, e)
